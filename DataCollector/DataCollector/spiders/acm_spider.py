...
class ArticleReferenceSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        self.item_x_paths={
            ...
            'abstract' : "string((//div[@class='flatbody']//p)[1])",
    ...
    def parse(self, response):
        ...
        item['ID'] = self.get_or_create_id(response)
        item['Link'] = response.url
        item['Title'] = response.xpath(self.item_x_paths['title']).extract_first()
        item['Abstract'] = response.xpath(self.item_x_paths['abstract']).extract_first()
        ...
        item['References_links'] = self.custom_preprocessor['references_link_preprocesssor'](
        ...
        item['Cited_by_links'] = self.custom_preprocessor['cited_by_link_preprocessor'](
    ...
    def get_or_create_id(self, response):
        url=response.url
